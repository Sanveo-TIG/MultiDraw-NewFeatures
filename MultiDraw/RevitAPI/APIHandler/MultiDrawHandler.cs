        ...
        public static void Mainfunction(UIApplication uiapp)
        {
            ...
            try
            {
              ...
              = categories.get_Item(
                ...
                List<ElementId> Pickedconduits = (from Reference r in pickedobj select r.ElementId).ToList();

                foreach (ElementId eid in Pickedconduits)
                {
                    Element ele = doc.GetElement(eid);
                    ParentUserControl.Instance.Primaryelst.Add(ele);
                }
                            ...
                            else
                            {
                                ...
                                if (ParentUserControl.Instance.AlignConduits.IsChecked == true)
                                {
                                    ...
                                    using (SubTransaction subone = new SubTransaction(doc))
                                    {
                                        ...
                                        {
                                            //globalParam.IsAlignConduit = (bool)ParentUserControl.Instance.AlignConduits.IsChecked;
                                        ...
                                        foreach (Element item in ParentUserControl.Instance.Primaryelst)
                                        {
                                            ...
                                            XYZ pt1 = ((conduit.Location as LocationCurve).Curve as Autodesk.Revit.DB.Line).GetEndPoint(0);
                                            XYZ pt2 = ((conduit.Location as LocationCurve).Curve as Autodesk.Revit.DB.Line).GetEndPoint(1);
                                            ...
                                            {
                                                (conduit.Location as LocationCurve).Curve = Autodesk.Revit.DB.Line.CreateBound(new XYZ(intersections.X, intersections.Y, pt1.Z), pt2);
                                            }
                                            else
                                            {
                                                (conduit.Location as LocationCurve).Curve = Autodesk.Revit.DB.Line.CreateBound(pt1, new XYZ(intersections.X, intersections.Y, pt2.Z));
                                            }
                                ...
                                else
                                {
                                    ...
                                    if (refparameterelement == null)
                                    {
                                        ...
                                        if (viewdrafting == null)
                                        {
                                            ...
                                            using (SubTransaction tranlen = new SubTransaction(doc))
                                            {
                                                ...
                                                verticaloffsetpattern.ForegroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.VoffsetColor.Value != null ? ProfileColorSettingUserControl.Instance.VoffsetColor.Value : new Color(255, 0, 0);
                                                verticaloffsetpattern.BackgroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.VoffsetColor.Value != null ? ProfileColorSettingUserControl.Instance.VoffsetColor.Value : new Color(255, 0, 0);
                                                ...
                                                Horizontaloffsetpattern.ForegroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.HoffsetColor.Value != null ? ProfileColorSettingUserControl.Instance.HoffsetColor.Value : new Color(255, 0, 0);
                                                Horizontaloffsetpattern.BackgroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.HoffsetColor.Value != null ? ProfileColorSettingUserControl.Instance.HoffsetColor.Value : new Color(255, 0, 0);
                                                ...
                                                rollingoffsetpattern.ForegroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.RoffsetColor.Value != null ? ProfileColorSettingUserControl.Instance.RoffsetColor.Value : new Color(255, 0, 0);
                                                rollingoffsetpattern.BackgroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.RoffsetColor.Value != null ? ProfileColorSettingUserControl.Instance.RoffsetColor.Value : new Color(255, 0, 0);
                                                ...
                                                Kick90offsetpattern.ForegroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.Kick90offsetColor.Value != null ? ProfileColorSettingUserControl.Instance.Kick90offsetColor.Value : new Color(255, 0, 0);
                                                Kick90offsetpattern.BackgroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.Kick90offsetColor.Value != null ? ProfileColorSettingUserControl.Instance.Kick90offsetColor.Value : new Color(255, 0, 0);
                                                ...
                                                Straightpattern.ForegroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.Strightor90Color.Value != null ? ProfileColorSettingUserControl.Instance.Strightor90Color.Value : new Color(255, 0, 0);
                                                Straightpattern.BackgroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.Strightor90Color.Value != null ? ProfileColorSettingUserControl.Instance.Strightor90Color.Value : new Color(255, 0, 0);
                                                ...
                                                Ninetykickpattern.ForegroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.NinetykickdrawColor.Value != null ? ProfileColorSettingUserControl.Instance.NinetykickdrawColor.Value : new Color(255, 0, 0);
                                                Ninetykickpattern.BackgroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.NinetykickdrawColor.Value != null ? ProfileColorSettingUserControl.Instance.NinetykickdrawColor.Value : new Color(255, 0, 0);
                                                ...
                                                NinetyStubpattern.ForegroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.ninetystubColor.Value != null ? ProfileColorSettingUserControl.Instance.ninetystubColor.Value : new Color(255, 0, 0);
                                                NinetyStubpattern.BackgroundPatternColor = ProfileColorSettingUserControl.Instance != null && ProfileColorSettingUserControl.Instance.ninetystubColor.Value != null ? ProfileColorSettingUserControl.Instance.ninetystubColor.Value : new Color(255, 0, 0);
                                    ...
                                    else if (ParentUserControl.Instance.cmbProfileType.SelectedIndex == 2)
                                    {
                                        ...
                                        {
                                            if (!APICommon.ROffsetdrawPointhandler(doc, uidoc, uiapp, ParentUserControl.Instance.Primaryelst, offsetVariable, Pickpoint, ref secondaryElements))
                                            {
                                                break;
                                            }
                                            else
