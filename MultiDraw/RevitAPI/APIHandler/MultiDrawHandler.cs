                                ...
                                if (refparameterelement == null)
                                {
                                    ...
                                    /*    //if (viewdrafting == null)
                                        //{
                                          ...
                                          //        //FilledRegionType myPatterns = (FilledRegionType)new FilteredElementCollector(doc).OfClass(typeof(FilledRegionType))./*Where(x => x.LookupParameter("Type").AsValueString().Equals("Solid Black"))
                                          //        FirstElement();
